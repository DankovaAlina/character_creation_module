...
def attack(char_name: str, char_class: str) -> str:
    """Рассчитывает единицы урона противнику."""
...
def defence(char_name: str, char_class: str) -> str:
    """Рассчитывает единицы защиты персонажа."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Определяет специальное умение персонажа."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Позволяет выбрать пользователю тип персонажа."""
    approve_choice: str = ''
    char_class: str = ''
